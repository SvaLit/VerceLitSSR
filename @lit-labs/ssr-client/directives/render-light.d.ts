...
declare class RenderLightDirective extends Directive {
    static _$litRenderLight: boolean;
    render(): void;
    update(part: ChildPart): unknown;
}
/**
 ...
 */
export declare const renderLight: () => import("lit/directive").DirectiveResult<typeof RenderLightDirective>;
...
//# sourceMappingURL=render-light.d.ts.map