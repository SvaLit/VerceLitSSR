...
export declare type SSRExpectedHTML = string | {
...
export declare type SSRTestFactory = () => SSRTestDescription;
export declare type SSRTest = SSRTestDescription | SSRTestFactory;
export declare type SSRTestSuite = {
    [name: string]: SSRTest;
};
