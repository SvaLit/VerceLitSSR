 ...
 * cases.
 */
const appModuleImport = importModule('../test-files/render-test-module.js', import.meta.url, getWindow({
...
const setup = async () => {
    ...
    const collectResult = async (iterable) => {
        let result = '';
    ...
    return {
        ...
        render: (r) => collectResult(appModule.namespace.render(r)),
        /** Renders the value with flattened shadow roots */
        renderFlattened: (r) => collectResult(appModule.namespace.render(r, undefined, true)),
    };
};
...
test('text expression with string value', async () => {
    ...
    assert.is(result, `<!--lit-part AEmR7W+R0Ak=--><div><!--lit-part-->foo<!--/lit-part--></div><!--/lit-part-->`);
});
test('text expression with undefined value', async () => {
    const { render, templateWithTextExpression } = await setup();
    const result = await render(templateWithTextExpression(undefined));
    assert.is(result, `<!--lit-part AEmR7W+R0Ak=--><div><!--lit-part--><!--/lit-part--></div><!--/lit-part-->`);
});
...
test('attribute expression with string value', async () => {
    ...
    assert.is(result, `<!--lit-part FAR9hgjJqTI=--><div class="foo"><!--lit-node 0--></div><!--/lit-part-->`);
});
test('multiple attribute expressions with string value', async () => {
    ...
    assert.is(result, `<!--lit-part FQlA2/EioQk=--><div x="foo" y="bar" z="not-dynamic"><!--lit-node 0--></div><!--/lit-part-->`);
});
test('attribute expression with multiple bindings', async () => {
    ...
    assert.is(result, `<!--lit-part D+PQMst9obo=--><div test="a foo b bar c"><!--lit-node 0--></div><!--/lit-part-->`);
});
...
test('HTMLInputElement.value', async () => {
    ...
    assert.is(result, `<!--lit-part AxWziS+Adpk=--><input value="foo"><!--lit-node 0--><!--/lit-part-->`);
});
test('HTMLElement.className', async () => {
    ...
    assert.is(result, `<!--lit-part I7NxrdZ/Zxo=--><div class="foo"><!--lit-node 0--></div><!--/lit-part-->`);
});
test('HTMLElement.classname does not reflect', async () => {
    const { render, elementTemplateWithClassnameProperty } = await setup();
    const result = await render(elementTemplateWithClassnameProperty('foo'));
    assert.is(result, `<!--lit-part I7NxrbZzZGA=--><div ><!--lit-node 0--></div><!--/lit-part-->`);
});
test('HTMLElement.id', async () => {
    ...
    assert.is(result, `<!--lit-part IgnmhhM3LsA=--><div id="foo"><!--lit-node 0--></div><!--/lit-part-->`);
});
/* Nested Templates */
test('nested template', async () => {
    const { render, nestedTemplate } = await setup();
    const result = await render(nestedTemplate);
    assert.is(result, `<!--lit-part AEmR7W+R0Ak=--><div><!--lit-part P/cIB3F0dnw=--><p>Hi</p><!--/lit-part--></div><!--/lit-part-->`);
});
/* Custom Elements */
test('simple custom element', async () => {
    ...
    assert.is(result, `<!--lit-part tjmYe1kHIVM=--><test-simple><template shadowroot="open"><!--lit-part UNbWrd8S5FY=--><main></main><!--/lit-part--></template></test-simple><!--/lit-part-->`);
});
test('element with property', async () => {
    ...
    assert.is(result, `<!--lit-part v2CxGIW+qHI=--><test-property ><!--lit-node 0--><template shadowroot="open"><!--lit-part UNbWrd8S5FY=--><main><!--lit-part-->bar<!--/lit-part--></main><!--/lit-part--></template></test-property><!--/lit-part-->`);
});
test('element with `willUpdate`', async () => {
    ...
    // TODO: we'd like to remove the extra space in the start tag
    assert.is(result, `<!--lit-part Q0bbGrx71ic=--><test-will-update  ><!--lit-node 0--><template shadowroot="open"><!--lit-part UNbWrd8S5FY=--><main><!--lit-part-->Foo Bar<!--/lit-part--></main><!--/lit-part--></template></test-will-update><!--/lit-part-->`);
});
...
test('no slot', async () => {
    ...
    assert.is(result, `<!--lit-part OpS0yFtM48Q=--><test-simple><template shadowroot="open"><!--lit-part UNbWrd8S5FY=--><main></main><!--/lit-part--></template><p>Hi</p></test-simple><!--/lit-part-->`);
});
/* Directives */
test('repeat directive with a template result', async () => {
    ...
    assert.is(result, '<!--lit-part AEmR7W+R0Ak=-->' +
        '<div>' +
...
test('repeat directive with a string', async () => {
    ...
    assert.is(result, '<!--lit-part BRUAAAUVAAA=-->' +
        '<!--lit-part-->' + // part that wraps the directive
...
test('simple class-map directive', async () => {
    ...
    assert.is(result, '<!--lit-part PkF/hiJU4II=--><div class="a c"><!--lit-node 0--></div><!--/lit-part-->');
});
test.skip('class-map directive with other bindings', async () => {
    ...
    assert.is(result, '<!--lit-part pNgepkKFbd0=--><div class="z hi a c"><!--lit-node 0--></div><!--/lit-part-->');
});
test.run();
//# sourceMappingURL=render-lit_test.js.map