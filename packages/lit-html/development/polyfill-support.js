...
(_a = (_b = globalThis)['litHtmlPlatformSupport']) !== null && _a !== void 0 ? _a : (_b['litHtmlPlatformSupport'] = function (Template, ChildPart) {
    ...
    var wrap = ENABLE_SHADYDOM_NOPATCH &&
        ((_a = extraGlobals.ShadyDOM) === null || _a === void 0 ? void 0 : _a.inUse) &&
        ((_b = extraGlobals.ShadyDOM) === null || _b === void 0 ? void 0 : _b.noPatch) === true
    ...
    childPartProto._$setValue = function (value, directiveParent) {
        ...
        if (container instanceof ShadowRoot && needsPrepareStyles(scope)) {
            ...
            if ((_c = extraGlobals.ShadyCSS) === null || _c === void 0 ? void 0 : _c.nativeShadow) {
