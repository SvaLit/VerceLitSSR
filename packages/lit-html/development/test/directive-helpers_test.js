...
import { getDirectiveClass, insertPart, isDirectiveResult, isPrimitive, isTemplateResult, removePart, TemplateResultType, } from '../directive-helpers.js';
...
suite('directive-helpers', () => {
    ...
    test('getDirectiveClass', () => {
        var _a;
        assert.instanceOf((_a = getDirectiveClass(classMap({}))) === null || _a === void 0 ? void 0 : _a.prototype, Directive);
