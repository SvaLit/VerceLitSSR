...
(canTestReactiveElement ? suite : suite.skip)('@query', () => {
  ...
  let C = _decorate(null, function (_initialize, _RenderingElement) {
    ...
    return {
      ...
      d: [{
        kind: "field",
        decorators: [query('#blah')],
        key: "div",
        value: void 0
      }, {
        kind: "field",
        decorators: [query('#blah', true)],
        key: "divCached",
        value: void 0
      }, {
        kind: "field",
        decorators: [query('span', true)],
        key: "span",
        value: void 0
      }, {
        kind: "field",
  ...
  test('returns cached value', async () => {
    el.condition = true;
    await el.updateComplete; // trigger caching, so we can verify that multiple elements can be cached
