...
(canTestReactiveElement ? suite : suite.skip)('@eventOptions', () => {
  ...
  test('allows capturing listeners', async function () {
    ...
    let C = _decorate(null, function (_initialize, _RenderingElement) {
      class C extends _RenderingElement {
        constructor(...args) {
          super(...args);
      ...
      return {
        ...
        d: [{
          ...
          value: function firstUpdated() {
            this.renderRoot.querySelector('div').addEventListener('click', e => this.onClick(e), this.onClick);
          }
        }]
      };
    }, RenderingElement);
  ...
  test('allows once listeners', async function () {
    ...
    let C = _decorate(null, function (_initialize2, _ReactiveElement) {
      class C extends _ReactiveElement {
        constructor() {
          super();
  ...
  test('allows passive listeners', async function () {
    ...
    let C = _decorate(null, function (_initialize3, _ReactiveElement2) {
      class C extends _ReactiveElement2 {
        constructor() {
          super();
      ...
      return {
        ...
        d: [{
          ...
          value: function onClick(e) {
            try {
              e.preventDefault();
            } catch (error) {// no need to do anything
            }
