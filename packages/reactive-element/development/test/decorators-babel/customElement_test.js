...
suite('@customElement', () => {
  test('defines an element', () => {
    ...
    let C0 = _decorate([customElement(tagName)], function (_initialize, _HTMLElement) {
      class C0 extends _HTMLElement {
        constructor(...args) {
          super(...args);
  ...
  test('elements with private constructors can be defined', () => {
    ...
    let C1 = _decorate([customElement(tagName)], function (_initialize2, _HTMLElement2) {
      class C1 extends _HTMLElement2 {
        constructor() {
          super();
