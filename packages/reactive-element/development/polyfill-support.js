...
(_a = (_b = globalThis)['reactiveElementPlatformSupport']) !== null && _a !== void 0 ? _a : (_b['reactiveElementPlatformSupport'] = function (_a) {
    var ReactiveElement = _a.ReactiveElement;
    var extraGlobals = window;
    // polyfill-support is only needed if ShadyCSS or the ApplyShim is in use
    // We test at the point of patching, which makes it safe to load
    // webcomponentsjs and polyfill-support in either order
    if (extraGlobals.ShadyCSS === undefined ||
    ...
    elementProto.createRenderRoot = function () {
        ...
        if (extraGlobals.ShadyCSS.nativeShadow) {
            ...
            if (!this.constructor.hasOwnProperty(SCOPED)) {
                ...
                (_b = (_a = extraGlobals.ShadyCSS) === null || _a === void 0 ? void 0 : _a.ScopingShim) === null || _b === void 0 ? void 0 : _b.prepareAdoptedCssText(css, name);
                if (this.constructor._$handlesPrepareStyles === undefined) {
                    extraGlobals.ShadyCSS.prepareTemplateStyles(document.createElement('template'), name);
                }
            }
